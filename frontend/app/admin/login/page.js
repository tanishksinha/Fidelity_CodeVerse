...
export default function AdminLogin() {
  ...
  const [password, setPassword] = useState('fidelity2024');
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-warroom-bg p-5 font-mono">
      <div className="w-full max-w-md">
        <div className="warroom-panel border-fidelity-green/30 p-8 shadow-glow-green/10">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-fidelity-green/10 text-fidelity-green">
              <Shield size={32} />
            </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded border border-warroom-border bg-warroom-bg py-3 pl-10 pr-4 text-sm text-white outline-none focus:border-fidelity-green"
            ...
            <button
              ...
              disabled={loading}
              className={cn(
                "flex w-full items-center justify-center gap-2 rounded bg-fidelity-green py-4 text-xs font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-[#009940] hover:shadow-glow-green",
                loading && "opacity-70"
              )}
            >
              {loading ? (
